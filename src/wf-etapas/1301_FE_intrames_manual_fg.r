...
AgregarVariables_IntraMes <- function(dataset) {
  ...
  # *************************************************************
  # Agrego las variables que genero el grupo 4
  # *************************************************************
  
  dataset[, varm_1 := mprestamos_personales/cliente_edad]
  dataset[, varm_2 := mcuentas_saldo/cproductos]
  dataset[, varm_3 := mcaja_ahorro/cliente_edad]
  dataset[, varm_4 := mpasivos_margen/cliente_antiguedad]
  dataset[, varm_5 := mcuentas_saldo/cliente_antiguedad]
  dataset[, varm_6 := mcuentas_saldo/(mrentabilidad^2)]
  dataset[, varm_7 := mcomisiones/mactivos_margen]
  dataset[, varm_8 := mprestamos_personales/(cliente_edad^2)]
