...
#------------------------------------------------------------------------------
# correccion del drifting por valor del dolar blue
...
drift_dolarblue <- function(campos_monetarios) {
  ...
  tb_USD <- as.data.table( list( vfoto_mes, vUSD) )
  
  colnames( tb_USD ) <- c( envg$PARAM$dataset_metadata$periodo, "USD" )
...
switch(envg$PARAM$metodo,
  ...
  "dolarblue"      = drift_dolarblue(campos_monetarios)
)
