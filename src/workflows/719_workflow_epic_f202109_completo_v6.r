...
FEintra_manual_base <- function( pinputexps )
{
  ...
  param_local$meta$script <- "/src/wf-etapas/1301_FE_intrames_manual_fg.r"
...
FEhist_base <- function( pinputexps)
{
  ...
  param_local$Tendencias1$ventana <- 16
  ...
  param_local$Tendencias2$ventana <- 16
...
TS_strategy_base9 <- function( pinputexps )
{
  ...
  #param_local$train$clase_minoritaria <- c( "BAJA+1")  # VERRRRRRRRRR
  
  
  
  param_local$final_train$undersampling <- 1.0
  param_local$final_train$clase_minoritaria <- c( "BAJA+1", "BAJA+2")
  param_local$final_train$training <- c(201906, 201907, 201908, 201909,
                                        201911, 201912, 202001, 202002,
                                        202008, 202009, 202010, 202011, 202012,
                                        202101, 202104, 202106)
  
  
  param_local$train$training <- c(201906, 201907, 201908, 201909,
                                  201911, 201912, 202001, 202002,
                                  202008, 202009, 202010, 202011, 202012,
                                  202101, 202104, 202106)
  param_local$train$validation <- c(202102)
